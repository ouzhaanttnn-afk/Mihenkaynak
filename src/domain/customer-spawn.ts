...
export function spawnCustomer(
  ...
  // --- Niyet ---
  // Çekirdek akış "dükkana satıyor"dur (GDD 23.23); erken oyunda baskındır.
  const intent: CustomerIntent = rng.pickWeighted([
    { value: 'sell' as const, weight: 74 },
    { value: 'buy' as const, weight: 14 },
    { value: 'service' as const, weight: 8 },
    { value: 'appraisal' as const, weight: 4 },
  ]);
