...
/**
 * ÇİZGİ İKON — gerçekçi mikro asset'i OLMAYAN simgeler için.
 *
 * Asset seti navigasyon, araç, kanal ve durum simgelerini kapsıyor; ayarlar
 * (ses, titreşim, dil, tema) o setin dışında kaldı. Var olmayan bir dosyaya
 * `img` göstermek kırık ikon demek olurdu; bu simgeler kodla çizilmeye
 * devam eder — GDD EK H "UI üretimi: kodla çizilir" zaten bunu söylüyor.
 */
function SvgLine({ size = 22, children, ...rest }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// ---------------------------------------------------------------------------
// Ayarlar — mikro asset seti dışında kalan simgeler
// ---------------------------------------------------------------------------
...
/** Tema / aydınlatma — ayarların ana ekrandaki kısa yolu. */
export const IconSun = (p: IconProps) => (
  <SvgLine {...p}>
    <circle cx="12" cy="12" r="4.2" />
    <path d="M12 2.4v2.4M12 19.2v2.4M21.6 12h-2.4M4.8 12H2.4M18.8 5.2 17.1 6.9M6.9 17.1 5.2 18.8M18.8 18.8 17.1 17.1M6.9 6.9 5.2 5.2" />
  </SvgLine>
);
